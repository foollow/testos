    ...
    'en': {
        settings: {
            ...
            system: {
                ...
                proxyUrl: 'Proxy URL',
                proxyDesc: 'URL used to bypass iframe restrictions (e.g. for engines and official sites).',
            },
    ...
    'zh-CN': {
        settings: {
            ...
            system: {
                ...
                placeholder: '选择语言',
                proxyUrl: '代理 URL',
                proxyDesc: '用于绕过 iframe 限制的 URL（例如用于搜索引擎和官网）。',
            },
    ...
    'zh-TW': {
        settings: {
            ...
            system: {
                ...
                placeholder: '選擇語言',
                proxyUrl: '代理 URL',
                proxyDesc: '用於繞過 iframe 限制的 URL（例如用於搜索引擎和官網）。',
            },
